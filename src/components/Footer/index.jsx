    ...
    return (
        <div className='footer'>
            <div className="footer__socials">
                <a>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="footer__icon" data-name="Facebook">
                ...
                <a>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="footer__icon" data-name="Instagram">
                ...
                <a>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="footer__icon" data-name="Twitter">
                ...
                <a>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="footer__icon" data-name="Youtube">
            ...
            <ul className='footer__list'>
                <li className='footer__list-item'><a className='footer__link'>Descriptive Audio</a></li>
                <li className='footer__list-item'><a className='footer__link'>help center</a></li>
                <li className='footer__list-item'><a className='footer__link'>gift card</a></li>
                <li className='footer__list-item'><a className='footer__link'>press</a></li>
                <li className='footer__list-item'><a className='footer__link'>investor relations</a></li>
                <li className='footer__list-item'><a className='footer__link'>jobs</a></li>
                <li className='footer__list-item'><a className='footer__link'>terms of use</a></li>
                <li className='footer__list-item'><a className='footer__link'>privacy</a></li>
                <li className='footer__list-item'><a className='footer__link'>legal notices</a></li>
                <li className='footer__list-item'><a className='footer__link'>cookie preferences</a></li>
                <li className='footer__list-item'><a className='footer__link'>Corporate information</a></li>
                <li className='footer__list-item'><a className='footer__link'>contact us</a></li>
            </ul>
            <button className='footer__button'>
                Service code
            </button>
            <div className='footer__copyright'>
                <span className='footer__copyright-text'>© 1997-2023 Netflix, Inc.</span>
            </div>
        </div>
    )
}
